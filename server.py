...
def clientthread(conn, nickname):
    score = 0
    conn.send("Welcome to the greek mythology quiz!".encode('utf-8'))
    conn.send("You will receive a question based on greek mythology. The answer to that question should be one of a, b, c or d\n".encode('utf-8'))
    conn.send("Good Luck!\n\n".encode('utf-8'))
